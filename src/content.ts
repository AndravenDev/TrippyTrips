...
export const tripContent: TripContent = {
  ...
  hero: {
    ...
    titleLine2Suffix: "!",
    description:
      "Дом паметника на Българската Комунистическа партия е емблематично място, което ще даде старта на сезона на пътуванията през 2026!",
    cta: "Виж плана",
    stats: [
    ...
    marquee: [
      ...
      { text: "★ БАЛКАНСКИ ВАЙБ" },
      { text: "· МУЗЕЙ НА ХУМУРА И САТИРАТА ·", highlighted: true },
  ...
  why: {
    ...
    description:
      "Района около Габрово е място където може да се видят доста неща. От гори и пещери, през внушителния паметник Бузлуджа до многобройните музеи в самия град.",
    cards: [
      {
        emoji: "🏛️",
  ...
  days: {
    eyebrow: "· СЪПКА ПО СТЪПКА",
    headingNormal: "Три дни, три дестинации, ",
    headingAccent: "без преходи!",
    description:
      "Идеаята е да си вземем Петък отпуска и да тръгнем към Габрово на 22.05, да нощуваме две вечери там и да се приберем в Неделя за да може в Понеделнк да сме се прибрали и да си починем преди да започне реботната седмица.",
    items: [
      {
        label: "Дестинация 1",
        title: "Габрово",
        subtitle: "Началото",
        body: "Пътя до габрово е малко над три часа, продполагам че ще пристигнем там по обяд. Програмата за първия ден ще е лека и лежерна, поенеже най-вероятно ще сме малко изморени от пътя. Ще намеря някоя спокойна вила където да се настаним и да редим ракии и салати. След настаняването може да посетим някои от многото музеи в Габрово като например интерактивния музей на индустрията или музея на хумура и сатирата!",
        time: "22.05.2026",
        image:
      ...
      },
      {
        ...
        title: "Бузлуджа",
        subtitle: "Паметникът",
        body: "Внушителния символ на Българския комунизъм Бузлуджа ще бъде втората ни дестинация от пътуването! Зависи къде точно ще отседнем, но грубо пътя от Габрово до Бузлуджа е един час с кола. Няма нужда от преход пеша, пътя стига точно до паметника. Това е единственото мероприятие предвидено за този ден, понеже целта е програмата да е спокойна и лежерна, но винаги можем да добавим оше дестинации, като например язовир Христо Смирненски.",
        time: "23.05.2026",
        image:
      ...
      },
      {
        ...
        tags: ["Пещера", "Сталактити", "Сталакмити"],
        sceneKey: "canyon",
        accent: "var(--accent-2)",
      },
    ],
