...
export const tripContent: TripContent = {
  ...
  days: {
    ...
    description:
      "Идеята е да тръгнем от Варна към Габрово на 22.05 след работа, да нощуваме две вечери там и да се приберем в неделя, за да може в понеделник да сме се прибрали и да си починем преди да започне работната седмица.",
    items: [
      {
        label: "Дестинация 1",
        title: "Габрово",
        subtitle: "Началото",
        body: "Пътят до Габрово е малко над три часа и половина, така че ако тръгнем от Варна към 18-19 часа, би трябвало да сме там до 22:30. Ще намеря някоя спокойна вила, където да се настаним и да редим ракии и салати.",
        time: "22.05.2026",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/c/c0/TownHall_Gabrovo.jpg",
        tags: ["Настаняване", "Пазаруване"],
        sceneKey: "pines",
        accent: "var(--accent-2)",
      },
      {
        ...
        tags: ["Паметник", "Планински изглед", "Съветски Брутализъм", "Разходка", "Музеи"],
        sceneKey: "vista",
        accent: "var(--accent-2)",
      },
      {
